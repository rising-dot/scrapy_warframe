...
class StatisticsSpider(scrapy.Spider):
    ...
    def parse(self, response):
        ...
        #     if "Prime Chassis" in link.get("item_name") or "Prime Blueprint" in link.get("item_name") or "Prime Systems" in link.get("item_name") or "Prime Neuroptics" in link.get("item_name") or "Prime Set" in link.get("item_name"):
